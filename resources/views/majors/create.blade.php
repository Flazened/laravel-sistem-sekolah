...
@section('content')
            ...
            <a href="{{ route('major.index') }}" class="text-xs uppercase tracking-[0.15em] text-slate-400 hover:text-[#A16207]">&larr; Buku 
        ...
        <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8"> 
            ...
            <div> 
                ...
                <input type="text" id="code" name="code" placeholder="Contoh: AKL, TLK & BID" 
            ...
            <div> 
                ...
                <input type="text" id="name" placeholder="Contoh: Akuntasi Keuangan dan Lembaga"
            ...
            <div> 
                ...
                <label for="name" 
                    ...
                    class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none"
                    placeholder="Contoh: Jurusan Yang Mempelajari Likuiditas suatu keuangan..."></textarea>
            </div> 
